<template>
  <!-- <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Mercado Pago Test</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">Railwai.</p>
    </div>
    <form id="form-checkout" class="mx-auto mt-16 max-w-xl sm:mt-20">
 ...
 <div class="px-6 py-24 sm:py-32 lg:px-8">
    <form id="form-checkout" class="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div id="form-checkout__cardNumber" class="font-semibold leading-6 text-gray-900"></div>
      <div id="form-checkout__expirationDate" class="font-semibold leading-6 text-gray-900"></div>
      <div id="form-checkout__securityCode" class="font-semibold leading-6 text-gray-900"></div>
      <input type="text" id="form-checkout__cardholderName" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      <select id="form-checkout__issuer"></select>
      <select id="form-checkout__installments"></select>
      <select id="form-checkout__identificationType"></select>
      <input type="text" id="form-checkout__identificationNumber" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      <input type="email" id="form-checkout__cardholderEmail" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      </div>
    <button type="submit"  class="block w-full rounded-full bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" id="form-checkout__submit">Pagar</button>
...
const mp = new window.MercadoPago("TEST-da73332a-6164-4864-87dd-c0a1fd69e777", {
  locale: "es-AR",
}); 
